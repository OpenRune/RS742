...
public class DxSurface extends GpuSurface implements DxInterface1 {
    ...
    public boolean method954() {
        this.field8845 = true;
        if (HRESULT.method18(IDirect3DDevice.SetRenderTarget(this.field8848.field9975, 0, this.field8851))) {
            return false;
        } else if (HRESULT.method18(IDirect3DDevice.SetDepthStencilSurface(this.field8848.field9975, this.field8846))) {
            return false;
        } else {
    ...
    public boolean method925() {
        ...
        return HRESULT.method19(IDirect3DDevice.SetDepthStencilSurface(this.field8848.field9975, 0L));
    }
