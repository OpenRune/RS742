...
@ObfuscatedName("abb")
public class GlxTexture extends GlxBaseTexture implements GpuTextureRelated1 {
    ...
    public GlxTexture(GlxToolkit arg0, int arg1, int arg2, boolean arg3, int[] arg4, int arg5, int arg6) {
        super(arg0, 3553, TextureFormat.field1296, DataType.field1501, arg1 * arg2, arg3);
        this.field8813 = arg1;
        this.field8812 = arg2;
        this.field3733.method13557(this);
    ...
    public GlxTexture(GlxToolkit arg0, TextureFormat arg1, int arg2, int arg3, boolean arg4, byte[] arg5, int arg6, int arg7) {
        ...
        if (arg4 && arg7 == 0 && arg6 == 0) {
            ...
            TextureFormat var10001 = this.field3736;
            if (this.field3736 == TextureFormat.field1303) {
                OpenGL.glCompressedTexImage2Dub(this.field3737, 0, 33777, arg2, arg3, 0, arg2 * arg3 / 2, arg5, arg6);
            } else {
                var10001 = this.field3736;
                if (this.field3736 == TextureFormat.field1295) {
                    OpenGL.glCompressedTexImage2Dub(this.field3737, 0, 33779, arg2, arg3, 0, arg2 * arg3, arg5, arg6);
                } else {
                    OpenGL.glTexImage2Dub(this.field3737, 0, GlxToolkit.method16100(this.field3736, this.field3731), arg2, arg3, 0, GlxToolkit.method16093(this.field3736), 5121, arg5, arg6);
                }
            }
            OpenGL.glPixelStorei(3314, 0);
        }
    ...
    public GlxTexture(GlxToolkit arg0, TextureFormat arg1, int arg2, int arg3, boolean arg4, float[] arg5, int arg6, int arg7) {
        ...
        if (arg4 && arg7 == 0 && arg6 == 0) {
            ...
            OpenGL.glPixelStorei(3314, arg7);
            OpenGL.glTexImage2Df(this.field3737, 0, GlxToolkit.method16100(this.field3736, this.field3731), arg2, arg3, 0, GlxToolkit.method16093(this.field3736), 5126, arg5, arg6 * 4);
            OpenGL.glPixelStorei(3314, 0);
        }
    }
    ...
    public void method14192(int arg0, int arg1, int arg2, int arg3, float[] arg4, TextureFormat arg5, int arg6, int arg7) {
        this.field3733.method13557(this);
        OpenGL.glPixelStorei(3314, arg7);
        OpenGL.glTexSubImage2Df(this.field3737, 0, arg0, arg1, arg2, arg3, GlxToolkit.method16093(arg5), 5121, arg4, arg6);
        OpenGL.glPixelStorei(3314, 0);
    }
    ...
    public GraphicsDeletable method4534(int arg0) {
        return new GlxRelated13(this, arg0);
    }
