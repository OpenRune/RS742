...
public class GlFloorModelRelated2 {
    ...
    @ObfuscatedName("cl.f")
    public GlFloorModelRelated4[][] field1145;
    ...
    public void method2276() {
        this.field1145 = new GlFloorModelRelated4[this.field1137][this.field1144];
        for (int var1 = 0; var1 < this.field1144; var1++) {
            for (int var2 = 0; var2 < this.field1137; var2++) {
                this.field1145[var2][var1] = new GlFloorModelRelated4(this.field1141, this, this.field1138, var2, var1, this.field1143, var2 * 128 + 1, var1 * 128 + 1);
            }
        }
    }
    ...
    public void method2277(int arg0, int arg1, int arg2, boolean[][] arg3, boolean arg4) {
        ...
        if (arg4) {
            for (int var7 = 0; var7 < this.field1144; var7++) {
                ...
                label128:
                for (int var10 = 0; var10 < this.field1137; var10++) {
    ...
    public void method2288(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int var9 = var5; var9 <= var6; var9++) {
            GlFloorModelRelated4[] var10 = this.field1145[var9];
