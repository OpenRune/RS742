...
public class GlEnvironmentMapEffect extends GlEffect {
    ...
    @ObfuscatedName("xs.q")
    public GlCubeTexture[] field7507;
    ...
    public GlEnvironmentMapEffect(GlToolkit arg0) {
        ...
        if (arg0.field8206) {
            ...
            this.field7507 = new GlCubeTexture[3];
            this.field7507[0] = new GlCubeTexture(this.field1062, TextureFormat.field1297, DataType.field1501, 128, false, var3, TextureFormat.field1297);
            this.field7507[1] = new GlCubeTexture(this.field1062, TextureFormat.field1297, DataType.field1501, 128, false, var4, TextureFormat.field1297);
            this.field7507[2] = new GlCubeTexture(this.field1062, TextureFormat.field1297, DataType.field1501, 128, false, var2, TextureFormat.field1297);
            this.method12797();
        }
    }
    ...
    public void method12797() {
        this.field7504 = new GlRenderList(this.field1062, 2);
