...
public class GlxFramebuffer extends GpuFramebuffer {
    ...
    public GlxRelated5 field10543;

    @ObfuscatedName("akc.z")
    public final GlxRelated5[] field10546 = new GlxRelated5[4];
    ...
    public void method1206(int arg0, GraphicsDeletable arg1) {
        int var3 = 0x1 << arg0;
        GlxRelated5 var4 = (GlxRelated5) arg1;
        if (arg1 == null) {
    ...
    public void method1207(EffectInterface arg0) {
        GlxRelated5 var2 = (GlxRelated5) arg0;
        if (arg0 == null) {
    ...
    public void method16955(int arg0) {
        GlxRelated5 var2 = this.field10546[arg0];
        if (var2 == null) {
