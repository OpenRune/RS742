...
public class OggVorbisStream extends OggStream {
    ...
    public OggVorbisStream(OggStreamState arg0) {
        super(arg0);
    }
    ...
    public void method15150(OggPacket arg0) {
        ...
        if (this.field10403 == -1.0D) {
            this.field10403 = (float) this.field10404 / (float) this.field10397.rate;
        }
        this.field10399.read(var3[0].length);
        this.field10404 += var3[0].length;
        OggVorbisStreamRelated2 var4 = this.field10402.method16470(var3[0].length, this.field10403);
