...
public class GpuWaterRelated {
    ...
    @ObfuscatedName("gj.t")
    public GpuVolumeTexture field2401 = null;

    @ObfuscatedName("gj.l")
    public GpuTexture[] field2408 = null;

    @ObfuscatedName("gj.f")
    public GpuVolumeTexture field2413 = null;

    @ObfuscatedName("gj.d")
    public GpuVolumeTexture field2410 = null;
    ...
    public GpuWaterRelated(GpuToolkit arg0) {
        ...
        if (this.field2405 && !this.field2404.method13547(TextureFormat.field1299, DataType.field1501)) {
            this.field2405 = false;
        }
        if (this.field2405 || this.field2404.method13546(TextureFormat.field1299, DataType.field1501)) {
            method4126();
            if (this.field2405) {
                byte[] var6 = Statics.method2896(Statics.field2411, false);
                this.field2401 = this.field2404.method13554(TextureFormat.field1299, 128, 128, 16, true, var6);
                byte[] var7 = Statics.method2896(Statics.field2407, false);
                this.field2413 = this.field2404.method13554(TextureFormat.field1299, 128, 128, 16, true, var7);
            } else {
    ...
    public boolean method4127() {
        ...
        if (this.field2410 == null) {
            if (Statics.field2403 == null) {
                byte[] var1 = WaterRelated5.method6999(128, 128, 16, 8, new GlEffectRelated3(419684), 4.0F, 4.0F, 16.0F, 0.5F, 0.6F);
            ...
            this.field2410 = this.field2404.method13554(TextureFormat.field1296, 128, 128, 16, true, var3);
        }
