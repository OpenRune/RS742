...
public class GlFloorModelRelated4 {
    ...
    @ObfuscatedName("bt.z")
    public GlFloorModelRelated4_Sub1 field1036;

    @ObfuscatedName("bt.n")
    public GlRelated2 field1029;

    public GlFloorModelRelated4(GlToolkit arg0, GlFloorModelRelated2 arg1, GlFloorModel arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        this.field1031 = arg0;
        this.field1032 = arg1;
        this.field1035 = arg6;
        this.field1040 = arg7;
    ...
    public void method2033() {
        ...
        if (this.field1029 == null) {
            this.field1029 = new GlRelated2(this.field1031, 3553, TextureFormat.field1297, DataType.field1501, 128, 128, false, this.field1031.field8230, TextureFormat.field1297, false);
            this.field1029.method12765(false, false);
            this.field1029.method2055(true);
        } else {
            this.field1029.method12769(0, 0, 128, 128, this.field1031.field8230, TextureFormat.field1297, 0, 0, false);
        }
    }
}
