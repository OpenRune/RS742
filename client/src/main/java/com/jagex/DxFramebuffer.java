...
public class DxFramebuffer extends GpuFramebuffer {
    ...
    public FrameBufferInterface field10537 = null;

    @ObfuscatedName("akh.d")
    public final DxGraphicsDeletable[] field10535 = new DxGraphicsDeletable[4];
    ...
    public boolean method16954(int arg0, long arg1) {
        return HRESULT.method19(IDirect3DDevice.SetRenderTarget(this.field10536.field9975, arg0, arg1));
    }

    @ObfuscatedName("akh.as(J)Z")
    public boolean method16942(long arg0) {
        return HRESULT.method19(IDirect3DDevice.SetDepthStencilSurface(this.field10536.field9975, arg0));
    }
    ...
    public boolean method954() {
        for (int var1 = 0; var1 < 4; var1++) {
            DxGraphicsDeletable var2 = this.field10535[var1];
            if (var2 != null) {
