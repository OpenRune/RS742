...
public class VarClanTypeList {
    ...
    @ObfuscatedName("wz.a")
    public SoftLruHashTable field7346 = new SoftLruHashTable(64);
    ...
    public VarClanType method12669(int arg0) {
        SoftLruHashTable var2 = this.field7346;
        VarClanType var3;
        synchronized (this.field7346) {
            var3 = (VarClanType) this.field7346.get((long) arg0);
        }
        if (var3 != null) {
            return var3;
        }
        ...
        synchronized (this.field7344) {
            var6 = this.field7344.fetchFile(Js5ConfigGroup.VARCLAN.field1668, arg0);
        }
        VarClanType var8 = new VarClanType();
        if (var6 != null) {
            var8.method12682(new Packet(var6));
        }
        SoftLruHashTable var9 = this.field7346;
        synchronized (this.field7346) {
    ...
    public void method12671() {
        SoftLruHashTable var1 = this.field7346;
        synchronized (this.field7346) {
