...
public class SampleRateConverter {
    ...
    public SampleRateConverter(int arg0, int arg1) {
        if (arg0 != arg1) {
    ...
    public byte[] method6555(byte[] arg0) {
        if (this.field4045 != null) {
            int var2 = (int) ((long) this.field4048 * (long) arg0.length / (long) this.field4046) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field4048 + var5;
                int var11 = var10 / this.field4046;
                var4 += var11;
                var5 = var10 - this.field4046 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method6552(int arg0) {
        if (this.field4045 != null) {
            arg0 = (int) ((long) this.field4048 * (long) arg0 / (long) this.field4046);
        }
        return arg0;
    }
    ...
    public int method6553(int arg0) {
        if (this.field4045 != null) {
            arg0 = (int) ((long) this.field4048 * (long) arg0 / (long) this.field4046) + 6;
        }
        return arg0;
    }
}
