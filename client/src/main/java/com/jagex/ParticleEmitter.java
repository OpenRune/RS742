...
public class ParticleEmitter {
    ...
    @ObfuscatedName("qo.j")
    public ParticleEmitterType field4901;
    ...
    @ObfuscatedName("qo.f")
    public ParticleEmitterRelated field4908 = new ParticleEmitterRelated();

    @ObfuscatedName("qo.d")
    public ParticleEmitterRelated field4909 = new ParticleEmitterRelated();
    ...
    public ParticleEmitter(RendererToolkit arg0, ModelParticleEmitter arg1, ParticleSystem arg2, long arg3) {
        ...
        if (!arg0.method765() && this.field4901.field2672 != -1) {
            this.field4901 = ParticleEmitterType.method2841(this.field4901.field2672);
        }
    ...
    public void method8070(RendererToolkit arg0, long arg1, int arg2, boolean arg3) {
        ...
        this.field4903 = 0;
        for (MovingParticle var7 = (MovingParticle) this.field4904.method11649(); var7 != null; var7 = (MovingParticle) this.field4904.method11644()) {
            ...
            if (this.field4912 > 63) {
                ...
                while (var23 < var20) {
                    ...
                    if (ParticleSystemRenderer.field4922 == ParticleSystemRenderer.field4921) {
                        var49 = new MovingParticle(this, var39, var40, var41, var24, var25, var26, var42, var43, var47, var44, var48, this.field4901.field2715, this.field4901.field2718);
                    } else {
        ...
        if (!this.field4908.method8136(this.field4909)) {
            ParticleEmitterRelated var50 = this.field4909;
    ...
    public void method8071(Scene arg0, RendererToolkit arg1, long arg2) {
        for (MovingParticle var5 = (MovingParticle) this.field4904.method11649(); var5 != null; var5 = (MovingParticle) this.field4904.method11644()) {
