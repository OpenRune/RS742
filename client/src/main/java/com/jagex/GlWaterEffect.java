...
public class GlWaterEffect extends GlEffect {
    ...
    @ObfuscatedName("xf.f")
    public GlShaderCompiler field7457;

    @ObfuscatedName("xf.d")
    public final GlWaterRelated field7458;
    ...
    public void method12787() {
        this.field7453 = new GlRenderList(this.field1062, 2);
    ...
    public void method2189(boolean arg0) {
        ...
        this.field1062.method13314(1);
        OpenGL.glMatrixMode(5890);
        OpenGL.glLoadMatrixf(this.field1062.field8117.entries, 0);
        OpenGL.glMatrixMode(5888);
        this.field1062.method13314(0);
