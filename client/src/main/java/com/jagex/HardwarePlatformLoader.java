...
public class HardwarePlatformLoader implements NativeLibraryLoader {
    ...
    public HardwarePlatformLoader(Js5 arg0) {
        this.field4159 = arg0;
        String var2 = "";
        if (NativeLibraryConfig.field7296.startsWith("win") || NativeLibraryConfig.field7296.startsWith("windows 7")) {
            var2 = var2 + "windows/";
        } else if (NativeLibraryConfig.field7296.startsWith("linux")) {
            var2 = var2 + "linux/";
        } else if (NativeLibraryConfig.field7296.startsWith("mac")) {
            var2 = var2 + "macos/";
        }
        String var3;
        if (NativeLibraryConfig.field7297.startsWith("amd64") || NativeLibraryConfig.field7297.startsWith("x86_64")) {
            var3 = var2 + "x86_64/";
        } else if (NativeLibraryConfig.field7297.startsWith("i386") || NativeLibraryConfig.field7297.startsWith("i486") || NativeLibraryConfig.field7297.startsWith("i586") || NativeLibraryConfig.field7297.startsWith("x86")) {
            var3 = var2 + "x86/";
        } else if (NativeLibraryConfig.field7297.startsWith("ppc")) {
            var3 = var2 + "ppc/";
        } else {
            var3 = var2 + "universal/";
        }
    ...
    public static String method3306(String arg0) {
        if (NativeLibraryConfig.field7296.startsWith("win")) {
            return arg0 + ".dll";
        } else if (NativeLibraryConfig.field7296.startsWith("linux")) {
            return "lib" + arg0 + ".so";
        } else if (NativeLibraryConfig.field7296.startsWith("mac")) {
