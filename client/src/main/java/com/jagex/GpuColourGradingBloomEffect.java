...
@ObfuscatedName("abr")
public class GpuColourGradingBloomEffect extends GpuPostProcessEffect {
    ...
    public GpuShader field8793;

    @ObfuscatedName("abr.f")
    public GpuProgram field8794;

    @ObfuscatedName("abr.d")
    public GpuProgram field8790;

    @ObfuscatedName("abr.z")
    public GpuProgram field8796;

    @ObfuscatedName("abr.n")
    public GpuProgram field8797;

    @ObfuscatedName("abr.o")
    public GpuProgram field8798;

    @ObfuscatedName("abr.q")
    public GpuProgramUniform field8799;

    @ObfuscatedName("abr.p")
    public GpuProgramUniform field8800;

    @ObfuscatedName("abr.w")
    public GpuProgramUniform field8788;

    @ObfuscatedName("abr.b")
    public GpuProgramUniform field8802;

    @ObfuscatedName("abr.x")
    public GpuProgramUniform field8801;

    @ObfuscatedName("abr.i")
    public GpuProgramUniform field8804;

    @ObfuscatedName("abr.v")
    public boolean field8791;

    public GpuColourGradingBloomEffect(GpuToolkit arg0) {
        super(arg0);
    }
    ...
    public void method4284(int arg0, Framebuffer arg1, GpuTexture arg2, EffectInterface arg3, GpuTexture arg4) {
