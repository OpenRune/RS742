...
public class LoadingScreenNewsManager implements Runnable {
    ...
    @ObfuscatedName("gf.u")
    public LoadingScreenNewsEntry[] field2332;
    ...
    public LoadingScreenNewsEntry method3991(int arg0) {
    ...
    public void run() {
        try {
            int var1 = client.modewhere == ModeWhere.LIVE ? 80 : Statics.field6773.field6768 + 7000;
            ...
            this.field2332 = new LoadingScreenNewsEntry[var5.length / 3];
            for (int var6 = 0; var6 < var5.length; var6 += 3) {
                this.field2332[var6 / 3] = new LoadingScreenNewsEntry(var5[var6], var5[var6 + 1], var5[var6 + 2]);
            }
