...
public final class PrioritizedCache {
    ...
    @ObfuscatedName("lc.c")
    public final PrioritizedCacheMode field3721;
    ...
    public Object method5949(Object arg0) {
        synchronized (this) {
            ...
            PrioritizedCacheEntry var3 = (PrioritizedCacheEntry) this.field3717.get(arg0);
            if (var3 == null) {
                return null;
            } else {
    ...
    public Object method5954(Object arg0, Object arg1) {
        synchronized (this) {
            ...
            PrioritizedCacheEntry var4 = (PrioritizedCacheEntry) this.field3717.get(arg0);
            if (var4 != null) {
            ...
            if (this.method5953() && this.field3717.size() == this.field3722) {
                PrioritizedCacheEntry var6 = (PrioritizedCacheEntry) this.field3719.remove();
    ...
    public Object method5960(Object arg0) {
        synchronized (this) {
            ...
            PrioritizedCacheEntry var3 = (PrioritizedCacheEntry) this.field3717.remove(arg0);
            if (var3 == null) {
                return null;
            }
    ...
    public void method5951(PrioritizedCacheEntry arg0, boolean arg1) {
        if (!arg1) {
    ...
    public void method5952() {
        ...
        while (!this.field3718.isEmpty()) {
            PrioritizedCacheEntry var3 = (PrioritizedCacheEntry) this.field3718.peek();
