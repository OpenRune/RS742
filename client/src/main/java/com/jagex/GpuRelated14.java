...
public class GpuRelated14 {
    ...
    public GpuRelated14(GpuToolkit arg0, GpuFloorModelHardShadows arg1, GpuFloorModel arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        this.field2451 = arg0;
        this.field2457 = arg1;
        this.field2452 = arg6;
        this.field2454 = arg7;
    ...
    public void method4365() {
        ...
        if (!this.field2451.method13546(TextureFormat.field1297, DataType.field1501)) {
        ...
        if (this.field2459 == null) {
            this.field2459 = this.field2451.method13549(TextureFormat.field1297, 128, 128, false, this.field2463);
            this.field2459.method4412(false, false);
        } else {
            this.field2459.method4414(0, 0, 128, 128, this.field2463, TextureFormat.field1297, 0, 128);
        }
    }
}
