...
public class VarnTypeList {
    ...
    @ObfuscatedName("ui.j")
    public final SoftLruHashTable field6758 = new SoftLruHashTable(64);
    ...
    public VarnType method12004(int arg0) {
        SoftLruHashTable var2 = this.field6758;
        VarnType var3;
        synchronized (this.field6758) {
            var3 = (VarnType) this.field6758.get((long) arg0);
        }
        if (var3 != null) {
            return var3;
        }
        ...
        SoftLruHashTable var7 = this.field6758;
        synchronized (this.field6758) {
    ...
    public void method12005() {
        SoftLruHashTable var1 = this.field6758;
        synchronized (this.field6758) {
