...
public class GlEnvironmentSampler_Sub2 extends GlEnvironmentSampler {
    ...
    public GlEnvironmentSampler_Sub2(GlToolkit arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        this.field9961 = arg0;
        this.field9956 = arg3;
        this.field9954 = arg4;
        this.field9958 = arg5;
    ...
    public GlCubeTexture method13186() {
        if (this.field9953 == null) {
            ...
            for (int var4 = 0; var4 < 6; var4++) {
                ...
                if (!var1.method898(field9957[var4], TextureRelated2.field4849, 1.0F, var3, var3, false)) {
                    return null;
                }
                if (var5.field1275 > 0) {
                    var2 = true;
