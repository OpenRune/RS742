...
public abstract class RendererToolkit {
    ...
    public final void method464(Framebuffer arg0) {
        if (this.field411 >= 3) {
            throw new RuntimeException();
        }
        if (this.field411 >= 0) {
    ...
    public final void method696(Framebuffer arg0) {
    ...
    public abstract GraphicsDeletable method468(int arg0, int arg1, TextureFormat arg2, DataType arg3, int arg4);
    ...
    public abstract EffectInterface method541(int arg0, int arg1, int arg2);
