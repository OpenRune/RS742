...
public class LoadingScreenRelated3 implements LoadingScreenElement {
    ...
    public void method3936() {
        ...
        this.field2334 = client.toolkit.createFont(var1, (PalettedSpriteData[]) SpriteDataProvider.method2593(this.field2335, this.field2337.field2644), true);
    }

    @ObfuscatedName("gb.j(ZI)V")
    public void method3932(boolean arg0) {
        if (arg0) {
            int var2 = this.field2337.field2645.method4586(this.field2337.field2642, client.frameWidth) + this.field2337.field2637;
            int var3 = this.field2337.field2641.method4574(this.field2337.field2643, client.frameHeight) + this.field2337.field2638;
