...
public class Whirlpool {
    ...
    public void method11980(byte[] arg0, long arg1) {
        ...
        while (arg1 > 8L) {
            ...
            this.field6748[this.field6752] = (byte) (var12 << 8 - var6 & 0xFF);
            this.field6749 += var6;
            arg1 -= 8L;
            var4++;
        }
        ...
        this.field6748[this.field6752] = (byte) (var13 << 8 - var6 & 0xFF);
        this.field6749 += (int) var14;
    }
    ...
    public void method11981(byte[] arg0, int arg1) {
        ...
        if (this.field6752 > 32) {
            while (true) {
                if (this.field6752 >= 64) {
                    this.method11993();
                    this.field6752 = 0;
                    break;
                }
                this.field6748[++this.field6752 - 1] = 0;
            }
        }
        while (this.field6752 < 32) {
            this.field6748[++this.field6752 - 1] = 0;
        }
