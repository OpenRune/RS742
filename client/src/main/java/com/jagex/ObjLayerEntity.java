...
public abstract class ObjLayerEntity extends GraphEntity {
    ...
    public boolean method15634(RendererToolkit arg0) {
        Vector3 var2 = this.getTransform().trans;
        PrimaryLayerEntityList var3 = this.field9808.method7438(this.level, (int) var2.x >> this.field9808.field4510, (int) var2.z >> this.field9808.field4510);
        return var3 != null && var3.field4642.field10512 ? this.field9808.field4493.method7590(this.level, (int) var2.x >> this.field9808.field4510, (int) var2.z >> this.field9808.field4510, var3.field4642.method12809() + this.method12809()) : this.field9808.field4493.method7599(this.level, (int) var2.x >> this.field9808.field4510, (int) var2.z >> this.field9808.field4510);
    }
