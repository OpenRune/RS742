...
public class OcclusionManager {
    ...
    @ObfuscatedName("od.t")
    public OcclusionSomething field4606;
    ...
    @ObfuscatedName("od.o")
    public Occluder[] field4600;

    @ObfuscatedName("od.q")
    public int field4614;

    @ObfuscatedName("od.p")
    public Occluder[] field4629;

    @ObfuscatedName("od.w")
    public int field4601;

    @ObfuscatedName("od.b")
    public Occluder[] field4616;

    @ObfuscatedName("od.x")
    public int field4617 = 0;

    @ObfuscatedName("od.i")
    public Occluder[] field4618;
    ...
    public OcclusionManager(Scene arg0) {
        ...
        this.field4605 = arg0;
        this.field4600 = new Occluder[537];
        this.field4630 = 0;
        this.field4629 = new Occluder[2003];
        this.field4614 = 0;
        this.field4616 = new Occluder[1019];
        this.field4601 = 0;
        this.field4618 = new Occluder[1045];
        this.field4617 = 0;
        ...
        if (this.field4624) {
            this.field4606 = new OcclusionSomething(this);
        }
    }
    ...
    public void method7615(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        if (arg0 != 8 && arg0 != 16) {
            ...
            this.field4616[this.field4601++] = new Occluder(this.field4605, arg0, arg1, var8, var9, var9, var8, var12, var13, var13 - arg4, var12 - arg4, var10, var11, var11, var10);
        } else {
            ...
            this.field4616[this.field4601++] = new Occluder(this.field4605, arg0, arg1, var14, var15, var15, var14, var18, var19, var19 - arg4, var18 - arg4, var16, var17, var17, var16);
        }
    }
    ...
    public void method7601(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int var6 = 0; var6 < this.field4601; var6++) {
            Occluder var7 = this.field4616[var6];
                ...
                for (int var8 = 0; var8 < this.field4605.field4496; var8++) {
                    ...
                    if (var9 != null) {
                        ...
                        if (var9.field4555 < 0) {
                            ...
                            this.field4629[this.field4614++] = new Occluder(this.field4605, 1, var6, var9.field4556 + var23, var9.field4556 + var23, var9.field4556 + var23, var9.field4556 + var23, var19, var21, var22, var20, var24, var25, var25, var24);
                        ...
                        if (var9.field4557 < 0) {
                            ...
                            this.field4629[this.field4614++] = new Occluder(this.field4605, 2, var6, var40, var41, var41, var40, var36, var38, var39, var37, var9.field4558 + var42, var9.field4558 + var42, var9.field4558 + var42, var9.field4558 + var42);
    ...
    public void method7594(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        this.field4600[this.field4630++] = new Occluder(this.field4605, arg0, arg1, arg2, arg3, arg3, arg2, arg6, arg7, arg7, arg6, arg4, arg4, arg5, arg5);
    }
    ...
    public void method7591(RendererToolkit arg0, int arg1) {
        ...
        if (this.field4617 > 0) {
            ...
            for (int var9 = 0; var9 < this.field4617; var9++) {
                Occluder var10 = this.field4618[var9];
    ...
    public void method7596(RendererToolkit arg0, Occluder arg1, int arg2) {
        Statics.field4625 = arg0;
    ...
    public boolean method7597(Occluder arg0, int arg1) {
