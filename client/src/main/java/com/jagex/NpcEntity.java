...
public class NpcEntity extends PathingEntity {
    ...
    public boolean method16151(RendererToolkit arg0, int arg1) {
        ...
        Model var11 = this.field8651[0] = this.type.getBodyModel(arg0, arg1, Statics.field3769, client.localPlayerGameState, var5, var6, this.field8633, this.field8654, var10, this.field10073, this.method13960(), false);
        if (var11 == null) {
            return false;
        }
    ...
    public int method13960() {
        ...
        if (this.type.multinpc != null) {
            NPCType var1 = this.type.getMultiNPC(client.localPlayerGameState);
    ...
    public int method12811() {
        ...
        return this.type.overlayheight == -1 ? super.method12811() : this.type.overlayheight;
    }
    ...
    public boolean method12814(RendererToolkit arg0, int arg1, int arg2) {
        ...
        for (int var6 = 0; var6 < this.field8651.length; var6++) {
            if (this.field8651[var6] != null) {
                ...
                label42:
                {
                    label41:
                    {
                        if (this.type.picksizeshift <= 0) {
                            if (this.type.picksize == -1) {
                                if (this.type.size != 1) {
                                    break label41;
                                }
                            } else if (this.type.picksize != 1) {
                                break label41;
                            }
                        }
                        var10000 = true;
                ...
                boolean var8 = this.field8651[var6].method272(arg1, arg2, var4, var7, this.type.picksizeshift);
                if (var8) {
                    var5 = true;
                    break;
                }
