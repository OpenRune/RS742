...
public class WorldSwitcher {
    ...
    @ObfuscatedName("uu.d")
    public static GWCWorld[] field6771 = new GWCWorld[0];
    ...
    public static void method11538() {
        ...
        while (true) {
            while (field6783 < Statics.field4875) {
                GWCWorld var0 = GWC.method3630(field6783);
    ...
    public static void method2587(boolean arg0, byte[] arg1) {
        ...
        for (int var3 = Statics.field4871; var3 <= Statics.field4875; var3++) {
            GWCWorld var4 = GWC.method3630(var3);
            if (var4 != null) {
                field6771[var2++] = var4;
            }
        }
    ...
    public static GWCWorld method6582() {
        field6780 = 0;
        return method3647();
    }

    @ObfuscatedName("fu.t(S)Laex;")
    public static GWCWorld method3647() {
    ...
    public static int method3310(GWCWorld arg0, GWCWorld arg1, int arg2, boolean arg3, int arg4, boolean arg5) {
    ...
    public static int method3101(GWCWorld arg0, GWCWorld arg1, int arg2, boolean arg3) {
        if (arg2 == 1) {
