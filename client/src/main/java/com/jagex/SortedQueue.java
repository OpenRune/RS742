...
public class SortedQueue extends AbstractQueue {
    ...
    public SortedQueueEntry[] field10519;
    ...
    public void method16917() {
        ...
        this.field10519 = (SortedQueueEntry[]) Arrays.copyOf(this.field10519, var1);
    }
    ...
    public boolean offer(Object arg0) {
        ...
        this.field10520++;
        if (var2 == 0) {
            this.field10519[0] = new SortedQueueEntry(arg0, 0);
            this.field10518.put(arg0, this.field10519[0]);
        } else {
            this.field10519[var2] = new SortedQueueEntry(arg0, var2);
    ...
    public boolean remove(Object arg0) {
        SortedQueueEntry var2 = (SortedQueueEntry) this.field10518.remove(arg0);
        if (var2 == null) {
            return false;
        }
        this.field10517++;
        ...
        SortedQueueEntry var3 = this.field10519[this.field10520];
        this.field10519[this.field10520] = null;
    ...
    public void method16900(int arg0) {
        SortedQueueEntry var2 = this.field10519[arg0];
        while (arg0 > 0) {
            int var3 = arg0 - 1 >>> 1;
            SortedQueueEntry var4 = this.field10519[var3];
    ...
    public void method16904(int arg0) {
        ...
        while (arg0 < var3) {
            int var4 = (arg0 << 1) + 1;
            SortedQueueEntry var5 = this.field10519[var4];
            int var6 = (arg0 << 1) + 2;
            SortedQueueEntry var7 = this.field10519[var6];
            int var8;
            if (this.field10521 == null) {
