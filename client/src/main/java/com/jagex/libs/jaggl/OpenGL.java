...
public class OpenGL {
    ...
    @ObfuscatedName("jaggl/OpenGL.u")
    public Hashtable field0;

    @ObfuscatedName("jaggl/OpenGL.j")
    public Thread field1;

    @ObfuscatedName("jaggl/OpenGL.a")
    public static Hashtable field2 = new Hashtable();

    @ObfuscatedName("jaggl/OpenGL.u(Ljava/lang/String;)Z")
    ...
    @ObfuscatedName("jaggl/OpenGL.j()Z")
    ...
    @ObfuscatedName("jaggl/OpenGL.a()Z")
