...
public class SkyBox {
    ...
    @ObfuscatedName("mq.s")
    public SkyBoxRelated field3929;

    @ObfuscatedName("mq.c")
    public SkyBoxRelated[] field3946;

    @ObfuscatedName("mq.m")
    public SkyBoxRelated[] field3931;
    ...
    public SkyBox(int arg0, SkyBoxRelated[] arg1, int arg2, int arg3, int arg4, int arg5, SkyBoxFillMode arg6, int arg7) {
        ...
        if (arg1 == null) {
            ...
            this.field3931 = new SkyBoxRelated[arg1.length];
    ...
    public void method6386(SkyBox arg0) {
        if (this.field3945) {
        ...
        if (this.field3933 != arg1) {
            ...
            if (this.field3946 != null) {
                ...
                for (int var6 = 0; var6 < this.field3946.length; var6++) {
                    SkyBoxRelated var7 = this.field3946[var6];
