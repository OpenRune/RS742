        ...
        while (true) {
            ...
            if (var2 == 1) {
                ...
                for (int var4 = 0; var4 < this.field5171.length; var4++) {
                    this.field5171[var4] = arg0.g1();
                    if (this.field5171[var4] != 0 && this.field5171[var4] == 2) {
                    }
                }
            } else if (var2 == 3) {
                this.field5173 = arg0.g1();
            } else if (var2 == 4) {
                this.field5174 = arg0.g1();
            } else if (var2 == 5) {
                this.field5176 = new int[arg0.g1()];
                for (int var5 = 0; var5 < this.field5176.length; var5++) {
                    this.field5176[var5] = arg0.g1();
                }
            } else if (var2 == 6) {
                this.field5172 = new int[arg0.g1()];
                for (int var6 = 0; var6 < this.field5172.length; var6++) {
                    this.field5172[var6] = arg0.g1();
                }
            }
        }
    }
