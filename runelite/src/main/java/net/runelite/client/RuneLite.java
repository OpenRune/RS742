...
public class RuneLite {
    ...
    public static File RUNELITE_DIR = new File(System.getProperty("user.home"), ".r742");

    public static File CACHE_DIR = new File(RUNELITE_DIR, "cache");
    public static File CACHE_DIR_DATA = new File(RUNELITE_DIR, "data");

    public static File PROFILES_DIR = new File(RUNELITE_DIR, "profiles");

    public static File PLUGINS_DIR = new File(RUNELITE_DIR, "plugins");
    public static File SCREENSHOT_DIR = new File(RUNELITE_DIR, "screenshots");
    public static File LOGS_DIR = new File(RUNELITE_DIR, "logs");
    public static File DEFAULT_SESSION_FILE = new File(RUNELITE_DIR, "session");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        parser.accepts("server-type", "Server Type");
        ...
        CACHE_DIR_DATA = new File(RUNELITE_DIR, "data");
